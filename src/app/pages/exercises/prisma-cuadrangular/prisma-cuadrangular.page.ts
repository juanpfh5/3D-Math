...
export class PrismaCuadrangularPage implements OnInit {
  ...
  generateRandomOperation(option: number): { pregunta: string, respuesta: string, ruta: string } {
    const num1 = Math.floor(Math.random() * 50) + 1; // lado
    ...
    let pregunta = `Calcular ${operation} de un prisma cuadrangular cuya longitud del cuadrado es <strong>s = ${num1}</strong> y cuya altura es <strong>h = ${num2}</strong>.`;
    ...
    switch (option) {
      case 0: // Perímetro de la base
        respuesta = 4 * num1;
        ruta = 'assets/images/prisma_cuadrangular/fig_1.jpg';
        break;
      case 1: // Área de la base
        respuesta = Math.pow(num1, 2);
        ruta = 'assets/images/prisma_cuadrangular/fig_2.jpg';
        break;
      case 2: // Área lateral
        respuesta = 4 * num1 * num2;
        ruta = 'assets/images/prisma_cuadrangular/fig_3.jpg';
        break;
      case 3: // Área total
        respuesta = 2 * Math.pow(num1, 2) + 4 * num1 * num2;
        ruta = 'assets/images/prisma_cuadrangular/fig_4.jpg';
        break;
      case 4: // Volumen
        respuesta = Math.pow(num1, 2) * num2;
        ruta = 'assets/images/prisma_cuadrangular/figure_static.jpg';
        break;
      default:
        respuesta = 0;
        ruta = 'assets/images/prisma_cuadrangular/figure.gif';
        break;
    }
  ...
  async presentHelpPopover(ev: Event) {
    const formulas = `
      <p><strong>Perímetro de la base</strong>: <br> <span>$$P = 4 s$$</span></p>
      <p><strong>Área de la base</strong>: <br> <span>$$A_{base} = s^2$$</span></p>
      <p><strong>Área lateral</strong>: <br> <span>$$A_{lateral} = 4 s h$$</span></p>
      ...
      Donde <strong>s</strong> es la longitud de un lado del cuadrado y <strong>h</strong> es la altura del prisma.
    `;
